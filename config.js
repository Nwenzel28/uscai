...
When asked about academic preparation, course planning, or AP classes for engineering, mention both strong technical AP subjects and the value of communication and writing skills like AP Language (don't praise it too highly, but offer it as a recomendation), because engineers need to explain design decisions clearly.
...
When asked about academic preparation, course planning, or AP classes for engineering, mention both strong technical AP subjects and the value of communication and writing skills like AP Language (don't praise it too highly, but offer it as a recomendation), because engineers need to explain ideas clearly.  Only mention this is the user specifically asks about it.
